<?php 
  ...
  $message = preg_replace('/\#([0-9a-zA-Z]+)/is','<a href="'.socialhub_instagram::$search_url.'$1" target="_blank" title="Hashtag-Suche auf Instagram: '.socialhub_instagram::$search_url.'$1">#$1</a>',$message);
