<?php $buttons = $this->getVar('buttons');?><div class="socialhub_share">
  ...
  <a class="shore-icon openModal" onclick="open('index.php?share=<?php echo urlencode($button['short']);?>&amp;rex_modal=1&amp;<?php echo $button['query'];?>','<?php echo $button['title'];?>','width=500 height=300');return false;" href="index.php?share=<?php echo $button['short'];?>&amp;rex_modal=1&amp;<?php echo $button['query'];?>" title="<?php echo $button['title'];?>">
